  ...
  return (
    <div id="contact" className="grid gap-16">
      <div
        ...
        className="sm:flex grid grid-cols-[auto,1fr] gap-x-2 pl-4 sm:pl-0 sm:text-center sm:justify-self-center"
      >
      ...
      <div
        ...
        data-aos-once="true"
        data-aos-anchor-placement="top-bottom"
        className="grid w-[85%] sm:w-[65%] text-3xl sm-4xl text-center justify-self-center"
      >
